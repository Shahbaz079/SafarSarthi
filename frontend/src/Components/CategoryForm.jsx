...
const CategoryForm = ({
  ...
  return (
    <div className="p-3 ">
      ...
      className="space-y-3">
        <input type="text" className="py-3 px-4 border border-lg w-full "
      ...
      {handleDelete && (
        ...
        className="bg-red-500 text-white py-2 px-4 rouned-lg hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-Opacity-50"
        >
          Delete
        </button>
      )}

            ...
            {userInfo?(
              <form onSubmit={submitHandler}>
                <div className="my-2">
                  ...
                  className="p-2 border roundede-lg xl:w-[28rem] text-white"
                  > 
                ...
                <div className="my-2">
                  ...
                  <textarea id="comment" rows="3" required value={comment} onChange={(e)=>setComment(e.target.value)}
                    className="p-2 border rounded-lg xl:w-[30rem] text-white" 
                    ></textarea>
                </div>
                <button
                type="submit"
        ...
        {activeTab==2 &&  (
          ...
          <div>
            {product.reviews.map((review)=>(
              <div className="bg-[#1A1A1A] roundede=lg xl:w-[30rem] xl:ml-[2rem] sm:ml-[0rem] sm:w-[15rem] mb-[5rem]" key={review._id}>
